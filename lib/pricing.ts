...
const CRYSTALS_PER_UNIT = 10;
const EUR_PER_UNIT = 0.99;

// Ціни привілеїв з ТЗ (technical/doc.txt), EUR — до появи товарів у бекенді.
const PRIVILEGE_EUR_BY_TITLE: Record<string, number> = {
  Silver: 10,
  Supreme: 20,
  Wither: 30,
  Hero: 40,
...
function eurToCurrency(eurAmount: number, currency: string): number {
...
function crystalsToEur(amount: number): number {
